...
**Subheading:**
KidneyMate asks people to record the private texture of their lives: what they drink, what they take, how they sleep, how they feel. We treat that as the responsibility it is. This page is the plain-English version of how.

---

## 2. Our promises [icon_points]
...
## 3. Privacy by design [rich_prose]
...
**Link:** the formal Privacy Policy (legal document) lives at /privacy-policy.

---

## 4. Humans stay accountable [split_content]
...
**Visual:** the three-layer diagram, review layer highlighted.

---

## 5. Explainable by design [split_content]

**Heading:** No black boxes, and we mean it mechanically

**Body:**
Every insight KidneyMate shows can answer the question "why am I seeing this?" in plain language: which records, which rule, what changed from your usual pattern. The analysis is rule-based precisely so this is always possible, for you and for the clinicians who need to stand behind what they act on.
...
**Visual:** insight card with explanation panel open.

---

## 6. Careful AI [rich_prose]
...
## 7. Governance [icon_points]

**Heading:** The unglamorous machinery of trust

- **Consent management.** Clear, specific, revocable, and logged: you can always see what you've agreed to.
- **Audit trails.** Access to records and clinical review actions are traceable: who, what, when.
- **Security practice.** Secure development, independent security testing before pilots, and an incident response plan we hope never to use.
- **Pilot governance.** Every pilot runs under formal ethics, privacy and clinical safety arrangements agreed with the partner service before any data moves.

---

## 8. FAQ selection [faq_accordion, audience=privacy]

Pulls: "Who can see my information?", "Where is my data stored?", "Can I delete my data?", "Will my data be sold?", "Is KidneyMate a medical device?"

---

## 9. Disclaimer note [disclaimer_note]
