...
**Subheading:**
The questions we hear most from patients, carers, clinicians and partners. If yours isn't here, ask us directly: a real person reads every message.
...
## 3. For patients and carers [faq_accordion, audience=patients]

**Does KidneyMate give medical advice?**
No. KidneyMate organises your records, shows you patterns, and offers general self-management insights in plain language. Anything clinical goes through your care team: that's the design, not a disclaimer.

**What if I'm on dialysis?**
KidneyMate is being built for the realities of dialysis life: session reminders and logging, fluid limits between sessions, and symptom tracking that gives your care team a fuller picture than the minutes before a session allow.

**I'm not good with technology. Is this for me?**
It has to be. KidneyMate is designed for tired people of every age: big type, one-to-two-tap entries, gentle reminders, and nothing that punishes you for missing a day. If our early users find any part confusing, that part gets rebuilt.

**Can my partner or carer use it with me?**
Yes, that's planned as a first-class feature, always under your control. You choose whether a carer can help with records and what they can see.

**What happens in an emergency?**
KidneyMate is not an emergency tool and never pretends to be. If you feel seriously unwell, call 000 or contact your care team immediately. The app reminds you of exactly this wherever it's relevant.

---

## 4. For clinicians [faq_accordion, audience=clinicians]

**What do clinicians actually see?**
A structured dashboard (in development): longitudinal trends against each patient's own baseline, rule-based review flags with the reasoning attached, and consultation-ready summaries. Patients control sharing; you control the rules and targets their data is interpreted against.

**How does this fit a ten-minute consultation?**
...
**How do pilots work?**
A conversation, then scoping, then governance (ethics, privacy, clinical safety), then a small supported cohort with co-designed evaluation. Register pilot interest and we'll start the conversation: no commitment implied.

---

## 5. Privacy and data [faq_accordion, audience=privacy]

**Who can see my information?**
You, and only the people you explicitly choose: for most users that means their care team, if and when they turn sharing on. Sharing is specific, visible in the app, and reversible.
...
Only with your explicit consent, appropriately de-identified, under formal research governance. Contributing to CKD research is an invitation, never a default.
...
**How can researchers or clinics get involved?**
Join the waitlist and tick research collaboration or clinician pilot, or use the contact form. Early collaborators shape the study designs, not just read about them.

---

## 7. Still curious [cta_banner]

**Heading:** Ask the question we didn't think of
**Text:** We'd rather answer directly than let a doubt sit.
**Button:** Get in touch
