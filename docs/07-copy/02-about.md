...
**Subheading:**
KidneyMate didn't start as a startup idea. It started as a research question: how do you turn the scattered daily work of living with kidney disease into something a care team can actually see and act on, without taking the human judgement out of it?

---

## 2. The origin [rich_prose]
...
## 3. Who we are [rich_prose]

**Heading:** A small team with overlapping obsessions

KidneyMate is built by a small multidisciplinary team working across health informatics research, software engineering, and clinical and data advisory. We're the kind of team that reads the KDIGO guidelines and the Apple Human Interface Guidelines in the same week, and thinks both matter.
...
*(Build note: team profile grid exists in the CMS behind the `show_team_grid` flag, off by default.)*

---

## 4. Why "Mate" [pull_quote + rich_prose]

**Pull quote:**
A mate is the one who shows up on the ordinary days. That's the whole idea.
...
## 5. What we believe [icon_points]

**Heading:** The principles we won't trade away

- **Steady beats flashy.** A tool people use every day has to be calm, fast and kind. We design for tired people first.
...
## 6. Where we are, and where we're going [timeline]
