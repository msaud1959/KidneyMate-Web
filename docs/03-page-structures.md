...
1. **Hero** [hero]: eyebrow, headline on the "days between appointments" idea, subline, primary CTA (waitlist), secondary CTA (how it works). Stylised app home screen floating in a device frame over a soft gradient field. Small honesty line: in development, grounded in a research framework under peer review.
2. **Trust strip** [logo_trust_strip]: four short proof points (research framework under peer review, shaped through around 50 stakeholder conversations, clinicians stay in charge, privacy by design). No logos at this stage; text marks with small icons.
...
9. **Grounded in research** [evidence_teaser]: our research framework (under peer review), one-line summary, validation roadmap note. Link to Research.
...
6. **The cost of the gap** [stat_band + rich_prose]: rising global burden and the awareness gap; missed early signals; pressure on services. Measured, not alarmist.
...
3. **Built on research** [evidence_teaser]: framework reference (under peer review), one paragraph.
...
5. **You are in control** [icon_points]: choose what to share, export your records, request deletion, accessibility of core support (no pricing claim).
...
5. **Evidence and governance** [evidence_teaser + icon_points]: research framework (under peer review), validation plan, privacy and security posture, human accountability.
...
6. **The staged pathway** [timeline]: capstone 2025, research framework and prototype 2026, MVP and pilot readiness 2026, clinical validation research 2027, dashboard integration 2027 to 2028.
...
2. **Our research framework** [paper_feature]: working title, status line (currently under peer review; no venue named), plain-language abstract, what the three layers are. Download link added only once publication is confirmed.
...
2. **The origin** [rich_prose]: started as university research into patient-generated health data in regional Victoria; became a research framework now under peer review; refined through a pre-accelerator program; now a working prototype. Told as a story, no individual names.
